...
function Cadastro() {
  return (
    <body className="w-dvw h-dvh flex flex-wrap  justify-center bg-[url(/src/img/pexels-dennisleinarts-1437953.jpg)] bg-center bg-no-repeat bg-cover bg-fixed"   >
        ...
        <main className=" flex flex-col justify-center max-w-120 h-65 border border-transparent rounded-xl mt-15 p-2 shadow-[2px_2px_10px_black]  backdrop-blur-[15px]"  >
          ...
          <form>
            ...
            <button className=" w-full rounded-md border-none mb-1 mt-2 bg-cyan-950 text-white p-1  hover:opacity-85 cursor-pointer delay-200  hover:scale-101 duration-100 ease-in-out font-bold " >Cadastrar</button>
          </form>
          <Link to="/login" className="text-center mb-1 font-bold hover:underline">Já tem uma conta?
            Faça login</Link>
        </main>
    </body>
  )
